...
function Contact() {
    ...
    return (
      ...
      <motion.div  ref={viewRef} variants={variants} initial='initial' animate='animate' className='flex flex-col md:flex-row lg:w-[1066px] h-[100vh] lg:h-screen justify-center p-10 md:p-0 items-center m-auto gap-2'>
          <motion.div variants={variants} className='flex-1 flex flex-col text-center md:text-left gap-6'>
              ...
              <motion.div variants={variants}>
                  <h2  className=' text-xl font-bold capitalize'>address</h2>
