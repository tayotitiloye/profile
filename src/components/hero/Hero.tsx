        ...
        <div className="h-[100%] overflow-hidden relative w-full flex flex-col justify-between">
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <g id="computer_x5F_desk">
                    <motion.path
                      ...
                      d="M168.651,260.609H65.247v67.813h103.404V260.609z M161.451,321.222H72.447v-53.411h89.004V321.222z"
                    ></motion.path>
                    <motion.path
                      initial={{ pathLength: 0 }}
                      animate={{ pathLength: 1 }}
                      transition={{ duration: 4 }}
                      d="M168.651,369.222H65.247v67.8h103.404V369.222z M161.451,429.822H72.447v-53.4h89.004V429.822z"
                    ></motion.path>
                    <motion.path
                      initial={{ pathLength: 0 }}
                      animate={{ pathLength: 1 }}
                    ...
                    <motion.path
                      ...
                      d="M374.055,365.885H253.031l-18.152-51.053l-6.784,2.411l18.795,52.863v83.7c0,3.979,3.237,7.215,7.215,7.215H372.98 c3.979,0,7.215-3.236,7.215-7.215v-83.7l18.796-52.863l-6.784-2.411L374.055,365.885z M372.98,453.822H254.105l-0.015-80.736 h118.904L372.98,453.822z"
                    ></motion.path>
                    <motion.path
                      initial={{ pathLength: 0 }}
                      animate={{ pathLength: 1 }}
                      transition={{ duration: 7 }}
                      d="M281.979,407.2h63.127c2.563,0,4.647-2.085,4.647-4.647v-11.816c0-2.563-2.085-4.646-4.647-4.646h-63.127 c-2.562,0-4.647,2.084-4.647,4.646v11.816C277.332,405.115,279.418,407.2,281.979,407.2z M284.533,393.289h58.021V400h-58.021 V393.289z"
                    ></motion.path>{" "}
                    <rect
                      height="7.199"
                      width="16.2"
                      ...
                      y="290.916"
                    ></rect>{" "}
                    <rect height="7.2" width="16.2" x="107.691" y="400"></rect>{" "}
                  </g>{" "}
                </g>
              </svg>
            </div>
          ...
          <div className="m-auto flex-1 mt-[220px] mb-4">
            <motion.div
              ...
              initial="initial"
              animate="animate"
              className="flex h-[100%] w-[60%] m-auto  flex-col gap-4 justify-center items-center"
            >
              <motion.h1
                variants={textVariants}
                className="text-3xl font-serif lg:text-4xl text-blue-300 font-medium tracking-wide"
              >
                Tayo Titiloye
              </motion.h1>
              <motion.h2
                variants={textVariants}
                className="text-3xl tracking-tighter text-justify lg:text-5xl font-medium"
              >
        ...
        <div className=" h-[100%] overflow-hidden relative w-full flex justify-between">
          ...
          <div className="h-[100%] m-auto lg:max-w-[1066px] flex-1">
            ...
            >
              <motion.h1
                variants={textVariants}
                className="text-3xl f font-serif md:text-4xl text-blue-300 font-bold tracking-widest"
              >
                Tayo Titiloye
              </motion.h1>
              <motion.h2
              ...
              <motion.div variants={textVariants} className=" ">
                <Link href={`#portfolio`} className="">
                  <motion.button
                    variants={textVariants}
                    className="border p-2 rounded-md mr-2 capitalize"
                  >
                    see my latest work
                  </motion.button>
                </Link>
                <Link href={`#contact`} className=" ">
                  <motion.button
                    variants={textVariants}
                    className="border p-2 rounded-md bg-white text-black capitalize"
                  >
                    contact me
                  </motion.button>
                </Link>
